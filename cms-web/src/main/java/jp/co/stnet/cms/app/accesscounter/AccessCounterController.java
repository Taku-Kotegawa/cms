...
import jp.co.stnet.cms.app.accesscounter.AccessCounterForm.Create;
import jp.co.stnet.cms.app.accesscounter.AccessCounterForm.Update;
...
//    }
    ...
    public String create(@Validated({Create.class, Default.class}) AccessCounterForm form,
...
//            }
    ...
    @TransactionTokenCheck
    public String update(@Validated({Update.class, Default.class}) AccessCounterForm form,
                         BindingResult bindingResult,
                         Model model,
                         RedirectAttributes redirect,
                         @AuthenticationPrincipal LoggedInUser loggedInUser,
